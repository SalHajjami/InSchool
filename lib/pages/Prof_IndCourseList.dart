...
class CoursIndividuelles extends StatefulWidget {
  const CoursIndividuelles({super.key});

  @override
  _CoursIndividuellesState createState() => _CoursIndividuellesState();
}

class _CoursIndividuellesState extends State<CoursIndividuelles> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Cours Individuelles"),
      ),
      body: Padding(
