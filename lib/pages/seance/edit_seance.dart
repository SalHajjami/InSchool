...
class _EditCoursePageState extends State<EditCoursePage> {
  ...
  void initState() {
    ...
    _niveauController = TextEditingController(text: widget.initialData['niveau']);
    _nombreEtudiantsController = TextEditingController(text: widget.initialData['nombre_etudiants'].toString());
    _startHourController = TextEditingController(text: widget.initialData['startHour']);
    _endHourController = TextEditingController(text: widget.initialData['endHour']);
